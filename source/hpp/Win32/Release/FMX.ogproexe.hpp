...
// (DO NOT EDIT: machine generated header) 'FMX.ogproexe.pas' rev: 30.00 (Windows)

#ifndef Fmx_OgproexeHPP
#define Fmx_OgproexeHPP
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_FMX_OGPROEXE)
using namespace Fmx::Ogproexe;
#endif
