...
// (DO NOT EDIT: machine generated header) 'FMX.onguard.pas' rev: 31.00 (Windows)
...
//-- type declarations -------------------------------------------------------
typedef void __fastcall (__closure *TChangeCodeEvent)(System::TObject* Sender, Fmx::Ogutil::TCode Code);
...
public:
	...
	void __fastcall SetCode(Fmx::Ogutil::TCode Value);
...
protected:
	...
	virtual void __fastcall Loaded(void);
	DYNAMIC void __fastcall DoOnChangeCode(Fmx::Ogutil::TCode Value);
