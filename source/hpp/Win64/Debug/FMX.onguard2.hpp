...
// (DO NOT EDIT: machine generated header) 'FMX.onguard2.pas' rev: 31.00 (Windows)

#ifndef Fmx_Onguard2HPP
#define Fmx_Onguard2HPP
...
private:
	...
	void __fastcall SetCodeType(Fmx::Ogutil::TCodeType Value);
	
public:
	void __fastcall SetKey(const Fmx::Ogutil::TKey &Value);
	void __fastcall GetKey(Fmx::Ogutil::TKey &Value);
	__property Fmx::Ogutil::TCode Code = {read=FCode};
	__property Fmx::Ogutil::TCodeType CodeType = {read=FCodeType, write=SetCodeType, nodefault};
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_FMX_ONGUARD2)
using namespace Fmx::Onguard2;
#endif
